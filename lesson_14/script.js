...
class Gamburger {
    ...
    get kkalSum() {
        ...
        let sum = this.gamburgerSize.calories;
        sum += this.insideIngredient.calories;
        for (let item of this.outerIngredients) {
            sum += item.calories;
        }
        return sum;
...
class GamburgerDecorator {
    ...
    get caloriesSum() { return this.gamburger.caloriesSum; }
